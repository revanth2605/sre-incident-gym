...
| **Qwen2.5-72B-Instruct Rule Agent** | **0.530** | **100%** |
...
```bash
python inference.py           # LLM-driven evaluation (set OPENAI_API_KEY, MODEL_NAME=Qwen/Qwen2.5-72B-Instruct, API_BASE_URL, HF_TOKEN as environment variables)
